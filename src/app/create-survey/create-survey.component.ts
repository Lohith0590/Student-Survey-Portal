  ...
  saveresponse() {
    this.studentService.postStudent(this.student).subscribe(
        succeed=>{
          ...
          if(this.d.getmean()>=90)
          {
            //this.router.navigate(['./list-surveywinner.component.html']);
            this.router.navigate(['./list-surveywinner']);
          }
          else
          {
            //this.router.navigate(["./list-survey.component.html"])
